...
import { EyeIcon, EyeOffIcon, Lock, UserCircle } from "lucide-react-native";
          ...
          <VStack space="xl">
            ...
            <VStack space="xs">
              ...
              <Input
                variant="outline"
                size="xl"
                className="rounded-xl border-gray-200 bg-gray-50 focus:border-[#195FA0] h-12"
              >
            ...
            <Button
              ...
              onPress={() =>
                toast.info(
                  "Em breve",
                  "Funcionalidade de recuperação será implementada.",
                )
              }
            >
